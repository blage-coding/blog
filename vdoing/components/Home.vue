    ...
    >
      ...
      >
        <header class="hero">
          ...
          />
          <h2 v-if="homeData.heroText" id="main-title" class="titleword">
            {{ homeData.heroText }}
          </h2>
          <h2 v-if="homeData.tagline" class="description">
            {{ homeData.tagline }}
          </h2>
  ...
  .banner
    ...
    .banner-conent
      ...
      .titleword
        ...
        background: -webkit-linear-gradient(left, #66ffe6, #ff0000) 0 0 no-repeat;/*设置线性渐变*/
